% FILE:     testLR1.m
% PURPOSE:  unit test LR table builder 
% METHOD:   try a few grammars
% REQUIRES: readg.m knuth.cfg X.cfg
% USAGE:    testLR1(t1, t2...) for tests t1, t2
% EXAMPLE:
%   testLR1() for all tests

% COPYRIGHT W.M.McKeeman 2008.  You may do anything you like with 
% this file except remove or modify this copyright.

function testLR1(varargin)                       % empty means all tests
  ...
  fprintf('LR1: passed %d unit tests out of %d\n', pass, testno);
