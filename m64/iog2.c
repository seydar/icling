        ...
        switch (*p) {
          case 'A':
            if (flagbits&asciiIOG){	        /* pass ascii */
              ...
              mode = SEARCH;                /* not builtin A: search on */
          ...
          case 'D':
            if (flagbits&digitIOG) {        /* pass digit */
              ...
              mode = SEARCH;                /* not builtin D: search on */
              ps++; *ps = p;                /* save return address */
              p = p0;                       /* start at beginning */
            }
            break;
          ...
          case 'l':
            ...
            break;
          ALPHA                             /* call new rule */
            mode = SEARCH;                    /*   not builtin, search on */
            ps++; *ps = p;                    /*   save return address */
