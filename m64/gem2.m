...
function obj = gem2()
  ...
  if strcmp(computer, 'GLNXA64')
    asm = [
      'p = i p;'                                      EOL ...
      'p =;'                                          EOL ...
      'i = ''pushR RBP''     e            "55";'      EOL ...
      'i = ''movRR RBP RSP'' e            "4889E5";'  EOL ...
      'i = ''xor RAX RAX''   e            "4833C0";'  EOL ...
      'i = ''leave''         e            "C9";'      EOL ...
      'i = ''ret''           e            "C3";'      EOL ...
     ['e = ''' EOL ''';']                             EOL ...
      ];
  ...
  if strcmp(computer, 'GLNXA64')
    calc = [
      ...
      'i = a;'                                      EOL ...
      'i = x;'                                      EOL ...
      'a = ''a='' "48B80" h "000000" '';'' ;'       EOL ...
      'a = ''b='' "48B90" h "000000" '';'' ;'       EOL ...
      'a = ''c='' "48BA0" h "000000" '';'' ;'       EOL ...
      'a = ''d='' "48BB0" h "000000" '';'' ;'       EOL ...
      'a = ''a='' "48B8" hh "000000" '';'' ;'       EOL ...
      'a = ''b='' "48B9" hh "000000" '';'' ;'       EOL ...
      'a = ''c='' "48BA" hh "000000" '';'' ;'       EOL ...
      'a = ''d='' "48BB" hh "000000" '';'' ;'       EOL ...
      'h = D;'                                      EOL ...
      'h = ''A''"A";'                               EOL ...
      'h = ''B''"B";'                               EOL ...
      'h = ''C''"C";'                               EOL ...
      ...
      'h = ''E''"E";'                               EOL ...
      'h = ''F''"F";'                               EOL ...
      sprintf('x = ''%c+=%c;'' "4801%c%c";\n',   rmRR),...
      sprintf('x = ''%c-=%c;'' "482B%c%c";\n',   mrRR),...
      sprintf('x = ''%c*=%c;'' "480FAF%c%c";\n', mrRR),...
      sprintf('x = ''%c|=%c;'' "480B%c%c";\n',   rmRR)... 
      % digitIOG
      ];
  else
    calc = [
  ...
  if strcmp(computer, 'GLNXA64')
    atoi = [
      'c = "554889E5" "4833C0" "48B90A00000000000000" p "C9C3";'  EOL ...
      'p = "480FAFC1" i p;'                         EOL ... EAX*=ECX;
      'p =;'                                        EOL ... EAX=0
      'i = ''0'';'                                  EOL ... EAX+=0;
      'i = ''1'' "4840";'                           EOL ... EAX+=1;
      'i = ''2'' "48050200000000000000";'           EOL ... EAX+=2;
      'i = ''3'' "48050300000000000000";'           EOL ... EAX+=3;
      'i = ''4'' "48050400000000000000";'           EOL ... EAX+=4;
      'i = ''5'' "48050500000000000000";'           EOL ... EAX+=5;
      'i = ''6'' "48050600000000000000";'           EOL ... EAX+=6;
      'i = ''7'' "48050700000000000000";'           EOL ... EAX+=7;
      'i = ''8'' "48050800000000000000";'           EOL ... EAX+=8;
      'i = ''9'' "48050900000000000000";'           EOL ... EAX+=9;
      ];
  else
    atoi = [
